        ...
        */
        ...
        if(sex[question] == sex[0]) {
            ...
            if(age >= ageToRetirement) {
                ...
                } else {JOptionPane.showMessageDialog(null, "Você não cumpre com todos os requisitos de Tempo de Contribuição para se aposentar!", "Tente novamente ano que vem...", JOptionPane.ERROR_MESSAGE);
                }
